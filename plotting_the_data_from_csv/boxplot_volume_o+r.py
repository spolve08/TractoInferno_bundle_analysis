...
# Data for plotting
x_data = ['AF_L_r', 'AF_L_o','FAT_L_r', 'FAT_L_o', 'IFOF_L_r', 'IFOF_L_o', 'ILF_L_r', 'ILF_L_o','PYT_L_r','PYT_L_o']
y_data = [volume_AF_L1, volume_AF_L2, volume_FAT_L1, volume_FAT_L2, volume_IFOF_L1,volume_IFOF_L2, volume_ILF_L1, volume_ILF_L2, volume_PYT_L1, volume_PYT_L2]
colors = ['rgba(93, 164, 214, 0.5)','rgba(93, 164, 214, 0.5)', 'rgba(255, 144, 14, 0.5)', 'rgba(255, 144, 14, 0.5)','rgba(44, 160, 101, 0.5)','rgba(44, 160, 101, 0.5)', 'rgba(255, 65, 54, 0.5)', 'rgba(255, 65, 54, 0.5)','rgba(207, 114, 255, 0.5)','rgba(207, 114, 255, 0.5)']
...
fig.write_html('/home/alberto/analysis_bundle_stats/plot/interactive_plot_o+r.html')
fig.show()