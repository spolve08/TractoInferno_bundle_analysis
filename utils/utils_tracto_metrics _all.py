...
# Paths and keywords
csv_path = "/home/alberto/analysis_bundle_stats/tract_info_csv/dsc_streamline_RBX_&_subj_space.csv"

folder_nilab1 = "/home/alberto/hd14tb/TractoInferno_Nilab_DetProb/derivatives/bundles_extracted_from_same_wbts"

folder_nilab2 = "/home/alberto/hd14tb/TractoInferno_Nilab_DetProb/derivatives/bundles_extracted_from_replicated_wbts_flipping"

folder_rbx = "/home/alberto/hd14tb/TractoInferno_Nilab_DetProb/derivatives/bundles_rbx"

folder_anat = "/home/alberto/hd14tb/TractoInferno_Nilab_DetProb"
...
for sub in os.listdir(folder_rbx):
    for keyword in keywords:
            ...
            path_anat = f"{folder_anat}/{sub}/anat/{sub}__T1w.nii.gz"
