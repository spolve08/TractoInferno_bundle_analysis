...
#/home/alberto/hd14tb/TractoInferno_Nilab_DetProb/derivatives/bundles_extracted_from_same_wbts/sub-1112/sub-1112__AF_L__DET_PROB.trk
    path_trk_1=f"{path_tractoinferno}derivatives/bundles_extracted_from_same_wbts/{sub}/{sub}__FAT_L__DET_PROB.trk"
    path_trk_2=f"{path_tractoinferno}derivatives/bundles_extracted_from_same_wbts/{sub}/{sub}__AF_L__DET_PROB.trk"
